...
export function ServiceBlock({ service, showExamples = false, compact = false }) {
  if (compact) {
    return (
      <article className="card-lift group relative flex h-full flex-col overflow-hidden rounded-xl border border-navy/[0.06] bg-white shadow-[0_16px_40px_-28px_rgba(15,47,104,0.35)]">
  ...
  return (
    <article className="card-lift flex h-full scroll-mt-28 flex-col overflow-hidden rounded-xl border border-navy/[0.07] bg-white shadow-[0_16px_40px_-28px_rgba(15,47,104,0.3)]">
      {service.image ? (
        <img
          src={service.image}
